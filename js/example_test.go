...
func Example_eventValue() {
	...
	handler := js.Handler(
		js.EventTarget().Prop("value").Assign(
			js.EventValue().Method("toUpperCase"),
		),
	)
	fmt.Println(handler)
...
func Example_conditionalLogic() {
	...
	handler := js.Handler(
		js.If(js.EventValue().Eq(js.String("")),
...
func Example_toggleClass() {
	...
	handler := js.Handler(
		js.ExprStmt(js.GetElementById(js.String("menu")).ClassListToggle(js.String("open"))),
	)
	fmt.Println(handler)
...
func Example_ternaryOperator() {
	...
	expr := js.Ident("isLoggedIn").Ternary(
		js.String("Logout"),
		js.String("Login"),
	)
	fmt.Println(js.ExprHandler(expr))
...
func Example_arrayMethods() {
	// Chain array methods
	expr := js.Ident("items").
		Method("filter", js.ArrowFunc([]string{"x"}, js.Ident("x").Prop("active"))).
		Method("map", js.ArrowFunc([]string{"x"}, js.Ident("x").Prop("name")))
	fmt.Println(js.ExprHandler(expr))
...
func Example_promiseChain() {
	...
	expr := js.Fetch(js.String("/api/users")).
		Then(js.ArrowFunc([]string{"r"}, js.Ident("r").Method("json"))).
		Catch(js.ArrowFunc([]string{"e"}, js.ConsoleError(js.Ident("e"))))
	fmt.Println(js.ExprHandler(expr))
...
func Example_keyboardShortcut() {
	...
	handler := js.Handler(
		js.If(js.EventCtrlKey().And(js.EventKey().Eq(js.String("s"))),
			js.ExprStmt(js.PreventDefault()),
...
func ExampleOnInput() {
	attr := js.OnInput(
		js.Ident("value").Assign(js.EventValue()),
	)
	fmt.Printf("%s=%q", attr.Name, attr.Value)
...
func ExampleOnSubmit() {
	attr := js.OnSubmit(
		js.ExprStmt(js.PreventDefault()),
		js.ExprStmt(js.This().Method("submit")),
	)
	fmt.Printf("%s=%q", attr.Name, attr.Value)
...
func ExampleExpr_Prop() {
	// Access nested properties
	expr := js.Ident("window").Prop("location").Prop("href")
	fmt.Println(js.ExprHandler(expr))
	// Output: window.location.href
}

func ExampleExpr_Method() {
	// Call a method with arguments
	expr := js.Ident("arr").Method("push", js.Int(1), js.Int(2))
	fmt.Println(js.ExprHandler(expr))
	// Output: arr.push(1, 2)
}
...
func ExampleArrowFunc() {
	...
	fn := js.ArrowFunc([]string{"a", "b"}, js.Ident("a").Add(js.Ident("b")))
...
func ExampleArrowFuncStmts() {
	...
	fn := js.ArrowFuncStmts([]string{"x"},
		js.Let("result", js.Ident("x").Mul(js.Int(2))),
...
func ExampleIf() {
	stmt := js.If(js.Ident("x").Gt(js.Int(0)),
...
func ExampleExpr_Ternary() {
	expr := js.Ident("age").Gt(js.Int(18)).Ternary(
		js.String("adult"),
		js.String("minor"),
	)
	fmt.Println(js.ExprHandler(expr))
...
func ExampleExpr_Await() {
	expr := js.Fetch(js.String("/api")).Method("json").Await()
	fmt.Println(js.ExprHandler(expr))
